...
public class MixedAPIAndSeleniumTests {
    ...
    //SeleniumUtiles seleniumUtiles = new SeleniumUtiles();
    ...
    public void testLogotypeOfUdemyMainPage() throws InterruptedException {
        ...
        Allure.step("fetch the element and make assertion", () -> {
            WebElement element = SeleniumUtiles.getWebDriverWait().until(ExpectedConditions.elementToBeClickable(SeleniumUtiles.getDriver().findElement(By.xpath("//img[@alt='Udemy']"))));
